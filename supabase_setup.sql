...
-- 既存の行があれば壊さない
insert into public.hangyodon (id, hunger, mood, level, exp, money, inventory, sleep_start_at, sleep_end_at, sleep_schedule_date, started_at, last_updated)
values (1, 100, 100, 1, 0, 100, '{}'::jsonb, null, null, null, now(), now())
